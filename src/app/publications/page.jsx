...
import { featuredPublications, journalPublications, publisherInfo, sparksReport } from "@/data_models/publishers";
      ...
      <div className="w-[90%] my-0 mx-auto space-y-20">
        ...
        >
          <p className="ptag font-bold text-2xl">
            Clean Cooking &amp; Market Readiness Reports
          </p>
          <br />

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-4">
            {featuredPublications.map((card) => (
              <div
                key={card.id}
